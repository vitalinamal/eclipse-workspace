...
public class MainTaskTwo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println(GroupFileStorage.loadGroupFromCSV(new File("Homework OOP 4\\src\\files\\prva.csv")));

			var file = GroupFileStorage.findFileByGroupName("prva", new File("Homework OOP 4\\src\\files"));
